                ...
                if activeTile != 0:
                    if activeTile.active == 0:
                        ...
                        if test:
                            ...
                            if direction != 2:
                                checkEast(1, places[self.row][self.col], self.colour)
                            if direction != 1:
                                checkWest(1, places[self.row][self.col], self.colour)
                            if direction != 5:
                                checkNorthWest(1, places[self.row][self.col], self.colour)
                            if direction != 6:
                                checkNorthEast(1, places[self.row][self.col], self.colour)
                            if direction != 4:                            
                                checkSouthEast(1, places[self.row][self.col], self.colour)
                            if direction != 3:
                                checkSouthWest(1, places[self.row][self.col], self.colour)

                            if direction != 1:
                                checkEast(1, places[activeSpot1[0]][activeSpot1[1]], places[activeSpot1[0]][activeSpot1[1]].colour)
                            if direction != 2:
                                checkWest(1, places[activeSpot1[0]][activeSpot1[1]], places[activeSpot1[0]][activeSpot1[1]].colour)
                            if direction != 4:                            
                                checkNorthWest(1, places[activeSpot1[0]][activeSpot1[1]], places[activeSpot1[0]][activeSpot1[1]].colour)
                            if direction != 3:                            
                                checkNorthEast(1, places[activeSpot1[0]][activeSpot1[1]],  places[activeSpot1[0]][activeSpot1[1]].colour)
                            if direction != 5:
                                checkSouthEast(1, places[activeSpot1[0]][activeSpot1[1]],  places[activeSpot1[0]][activeSpot1[1]].colour)
                            if direction != 6:
                                checkSouthWest(1, places[activeSpot1[0]][activeSpot1[1]],  places[activeSpot1[0]][activeSpot1[1]].colour)
...
def checkEast(deep, space, colour):
    try:
        ...
        if newSpace.colour == colour:
            ...
            if deep:
                checkEast(deep, newSpace, colour)

def checkWest(deep, space, colour):
    try:
        newSpace = places[space.row][space.col-1]
    except:
        print("Something went wrong")
        ...
        if newSpace.colour == colour:
            ...
            incrementScore(colour)
            if deep:
                checkWest(deep, newSpace, colour)


def checkNorthEast(deep, space, colour):
    if space.row < 8:
    ...
    if colour == newSpace.colour:
        print("NortEast")
        incrementScore(colour)
        checkNorthEast(1, newSpace, colour)


def checkNorthWest(deep, space, colour):
    if space.row < 8:
        newSpace = places[space.row-1][space.col-1]
    else:
        newSpace = places[space.row-1][space.col]
    ...
    if colour == newSpace.colour:
        print("NortWest")
        incrementScore(colour)
        checkNorthWest(1, newSpace, colour)

def checkSouthEast(deep, space, colour):
    if space.row < 7:
        newSpace = places[space.row+1][space.col+1]
    else:
        newSpace = places[space.row+1][space.col]
    ...
    if colour == newSpace.colour:
        print("SouthEast")
        incrementScore(colour)
        checkSouthEast(1, newSpace, colour)    

def checkSouthWest(deep, space, colour):
    if space.row < 7:
        newSpace = places[space.row+1][space.col]
    else:
        newSpace = places[space.row+1][space.col-1]
    ...
    if colour == newSpace.colour:
        print("SouthWest")
        incrementScore(colour)
        checkSouthWest(1, newSpace, colour)  
